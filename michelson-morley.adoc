...
answer. The answer is that they are the speeds of wavefronts on either
side of a longitudinally moving antenna or light source, with respect
to a stationary object. At the dawn of the 20th century, very young
Einstein instead mistakenly assumes the speed of a wavefront is always
\(c\). He arrives at absurd conclusions and becomes a celebrity
precisely because of that, practically guaranteeing he will be stuck
with the theory for life.
