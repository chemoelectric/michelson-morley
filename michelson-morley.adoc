...
We thus now have enough to locate a pole and then to locate a point on
the ellipse relative to the pole. It also will be possible to extend
the method to three dimensions and ellipsoids.
