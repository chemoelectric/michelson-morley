...
areal scale of \( ( ( 1+v/c )( 1-v/c ) )^{-1} \). This scale is
symmetric with respect to whether the antenna is receding or
approaching. It is unity for a stationary antenna.
[.big]#*FIXME: I need a proof this is the correct scale!!!!!*#



//Let us deal with the variation in “speed of light” by a change of
//scale in surface area.
//
//[cols="1,1"]
//|===
//|Electromagnetic speed|Scale factor
//|\(c-v\)|\(1-(v/c)\)
//|\(c\)|\(1\)
//|\(c+v\)|\(1+(v/c)\)
//|===
