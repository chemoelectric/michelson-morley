...
[.big]#*FIXME: PUT A PROOF HERE, SUCH AS BY A TIMED PROCESS OF
...
( 1+v/c ) ( 1-v/c ) \). This is a clear indication the expression is
the product of two speeds. What speeds? The question demands an
