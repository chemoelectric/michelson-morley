...
answer. They are the speeds of wavefronts on either side of a
longitudinally moving antenna or light source, with respect to a
stationary object. At the dawn of the 20th century, very young
