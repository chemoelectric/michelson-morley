...
== Further analysis of electromagnetic Doppler shift
...
moving antenna in <<DiagramE,Diagram E>> is \(-v\mkern2mu e_1\). In other
words, \(e_1\) points to the right. Let \(e_2\) be the orthogonal
vector for which \(e_1\wedge e_2 = 1\) by the right hand rule. Thus
\(e_2\) points upwards.
